...
#region CustomFunctions
	# Desc: ...
		function UpdateBCSLobSystemProperties($vars, [string]$lobName){
			$lob = Get-SPBusinessDataCatalogMetadataObject -BdcObjectType "LobSystem" -Name $lobName -ServiceContext $vars["SiteUrl"]

			$instance = $lob.LobSystemInstances | Where-Object {$_.Name -eq $lobName}

			Set-SPBusinessDataCatalogMetadataObject –Identity $instance –PropertyName "DBServerName" –PropertyValue $vars["BCS_Requests_DBServerName"]

			Set-SPBusinessDataCatalogMetadataObject –Identity $instance –PropertyName "DBName" –PropertyValue $vars["BCS_Requests_DBName"]

			Set-SPBusinessDataCatalogMetadataObject –Identity $instance –PropertyName "SecureStoreAppId" –PropertyValue $vars["BCS_Requests_CredentialsSecureStoreAppId"]
