...
(
    ...
    [MO] bit NOT NULL CONSTRAINT [DF_LicenseMo_MO] DEFAULT 1,
    ...
    CONSTRAINT [FK_LicenseMo_ToLicenseMo_Parent] FOREIGN KEY ([Parent]) REFERENCES [dbo].[LicenseMo]([Id]),
    CONSTRAINT [FK_LicenseMo_ToLicenseMo_RootParent] FOREIGN KEY ([RootParent]) REFERENCES [dbo].[LicenseMo]([Id]) 
)
