CREATE PROCEDURE [dbo].[InsertRequestAccountForXMLBody]
	@SOURCEXQUERY NVARCHAR(MAX), -- EXAMPLE N'/CoordinateMessage/Message/Declarant[@xsi:type="RequestAccount"]
	@XMLBODY XML,
	@RECORDID INT OUTPUT
AS
	...
	EXEC [dbo].[InsertRecordForXMLBody] N'DBO', N'REQUESTACCOUNT', @VALUES, @SOURCEXQUERY, @XMLBODY, @RECORDID OUTPUT;
RETURN 0
