...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendRequestPTSPage.aspx.cs" Inherits="TM.SP.AppPages.SendRequestPTSPage" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <SharePoint:ScriptBlock runat="server">
        var ShowPTSSendWaitingScreen = function(){
      ...
      <wssuc:ButtonSection runat="server" ShowStandardCancelButton="False">
        <Template_Buttons>
          <asp:placeholder ID="Placeholder1" runat="server">
            <asp:Button runat="server" class="ms-ButtonHeightWidth" ID="BtnOk" Text="Ok" OnClientClick="ShowPTSSendWaitingScreen();" UseSubmitBehavior="false"/>              
            <SeparatorHtml>
