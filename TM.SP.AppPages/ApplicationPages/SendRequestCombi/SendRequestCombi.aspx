...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/ApplicationPages/SendRequestCombi/SendRequestCombi.aspx.cs" Inherits="TM.SP.AppPages.SendRequestCombi" DynamicMasterPageFile="~masterurl/default.master" %>
      ...
      <wssuc:ButtonSection runat="server" ShowStandardCancelButton="False">
        <Template_Buttons>
          <asp:placeholder ID="Placeholder1" runat="server">
            <asp:Button runat="server" class="ms-ButtonHeightWidth" ID="BtnOk" Text="Ok" OnClientClick="ShowSendWaitingScreen();" UseSubmitBehavior="false"/>              
            <SeparatorHtml>
